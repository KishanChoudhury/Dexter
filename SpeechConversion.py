...
class Microsoft_ASR():
    def __init__(self):
        self.sub_key = 'd2fb6c9a166e4f4d91b3b6ea23921bb0'
        self.token = None
        pass
    ...
    def transcribe(self,speech_file):
        ...
        headers = {'Authorization': 'Bearer ' + self.token.decode(encoding='UTF-8'), 
...
if __name__ == "__main__":
    ...
    text, confidence = ms_asr.transcribe('F:/BacktoRobotics/Hackathon/Voice sample/5925001-17-12-44.wav')
    print(("Text: ", text))
